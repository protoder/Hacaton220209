...
class TTeilorGenetic(BaseGenetic.TBaseGenetic):
    def __init__(self):
        BaseGenetic.TBaseGenetic.__init__(self, HromosomLen = 8, FixedGroupsLeft=0, StopFlag=2, PopulationSize = 100)
...
Gn = TTeilorGenetic()
Gn.PDeath = 0.4
Gn.PMutation = 0.4 # probability of the mutation for any individuals. Or, if >=1, the number of individuals that will die in each generation
